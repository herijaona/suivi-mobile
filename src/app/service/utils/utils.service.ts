...
import { IProposeRdv } from "src/app/praticien/patient-proposition-rendez-vous/patient-proposition-rendez-vous.component";
import { CUSTOMSHOW } from "src/app/CUSTOMSHOW";
...
export class UtilsService {
  ...
  constructor(private http: HttpClient, private plt: Platform) {
    this.currentUserSubject = new BehaviorSubject<UtilsService>(
  ...
  async isToken(): Promise<Users> {
    ...
    this.tok = value;
    const istoken = Object.keys(JSON.parse(this.tok)).map((k) =>
      JSON.parse(this.tok)
    );
  ...
  async getCarnetVaccinationId(id): Promise<any> {
    ...
    return this.http
      .get(
        this.url +
          "carnet_vaccinations?patient=" +
          id +
          "&order[datePriseInitiale]=asc&datePriseInitiale[after]=" +
          dateNow,
        { headers: headers }
      )
      .toPromise();
  ...
  async getConsultationById(id): Promise<any> {
    ...
    return this.http
      .get(
        this.url +
          "intervation_consultations?patient=" +
          id +
          "&order[dateConsultation]=asc&dateConsultation[after]=" +
          dateNow,
        { headers: headers }
      )
      .toPromise();
  ...
  async getConsultationRejectByID(): Promise<any> {
    ...
    return this.http
      .get(this.url + "ordoconsultation_rejected", { headers: headers })
      .toPromise();
  }
  ...
  async getConsultationProgressByID(): Promise<any> {
    ...
    return this.http
      .get(this.url + "ordoconsultation_in_progress", { headers: headers })
      .toPromise();
  }
  ...
  async getInfoCurrentUser(): Promise<any> {
    ...
    return this.http
      .get(this.url + "current_user_check", { headers: headers })
      .toPromise();
  }
  ...
  async getGroupFamilleListByPatient(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "families?patientChild=" + id, { headers: headers })
      .toPromise();
  }
  ...
  async getListMembresByGroup(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "families?groupFamily=" + id, { headers: headers })
      .toPromise();
  }
  ...
  async getGroupFamille(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "group_families?patient=" + id, { headers: headers })
      .toPromise();
  }
  ...
  state() {
    ...
    return this.http
      .get<State>(this.url + "/states", { headers: headers })
      .pipe(
        tap((user) => {
  ...
  async ordoVaccinations(): Promise<any> {
    ...
    return this.http
      .get(this.url + "ordo_vaccinations", { headers: headers })
      .toPromise();
  }
  ...
  /* async getPatients(): Promise<any> {
    ...
    return this.http
      .get(this.url + "patients", { headers: headers })
      .toPromise();
  } */

  getPatients() {
    return this.isToken().then((data) => {
      const headers = new HttpHeaders({
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  public ordoVaccinationId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "ordo_vaccinations/" + id + "", { headers: headers })
      .toPromise();
  }
  ...
  async getCentreHealh(): Promise<any> {
    ...
    return this.http
      .get(this.url + "centre_healths", { headers: headers })
      .toPromise();
  }
  ...
  async getCentreHealhId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "centre_healths/" + id + "", { headers: headers })
      .toPromise();
  }
  ...
  async getVaccin(): Promise<any> {
    ...
    return this.http
      .get(this.url + "vaccins/", { headers: headers })
      .toPromise();
  }
  ...
  async gerVaccinId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "vaccins/" + id + "", { headers: headers })
      .toPromise();
  }
  ...
  async getCarnetVaccination(): Promise<any> {
    ...
    return this.http
      .get(this.url + "carnet_vaccinations", { headers: headers })
      .toPromise();
  }
  ...
  async getPatientCarnetVaccination(): Promise<any> {
    ...
    return this.http
      .get(this.url + "patient_carnet_vaccinations/", { headers: headers })
      .toPromise();
  }
  ...
  async getPatientCarnetVaccinationId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "patient_carnet_vaccinations/" + id + "", {
        headers: headers,
      })
      .toPromise();
  }
  ...
  async getIntervationtVaccination(): Promise<any> {
    ...
    return this.http
      .get(this.url + "intervention_vaccinations/", { headers: headers })
      .toPromise();
  }
  ...
  async getIntervationtVaccinationId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "intervention_vaccinations/" + id + "", {
        headers: headers,
      })
      .toPromise();
  }
  ...
  async getPraticiens(): Promise<any> {
    ...
    return this.http
      .get(this.url + "praticiens/", { headers: headers })
      .toPromise();
  }
  ...
  async getPraticiensId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "praticiens/" + id + "", { headers: headers })
      .toPromise();
  }
  ...
  async getGroupFamilleId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "group_families/" + id + "", { headers: headers })
      .toPromise();
  }
  ...
  async getFamille(): Promise<any> {
    ...
    return this.http
      .get(this.url + "families/", { headers: headers })
      .toPromise();
  }
  ...
  async getFamilleId(id): Promise<any> {
    ...
    return this.http
      .get(this.url + "families/" + id + "", { headers: headers })
      .toPromise();
  }

  async getAllRdv(id): Promise<any> {
    this.token = await this.isToken();
    let dateNow = moment(new Date()).format("YYYY-MM-DD");
    const headers = new HttpHeaders({
      Accept: "application/json",
    ...
    const res = this.http
      ...
      .toPromise();
    console.log("#UTILS > GetALLRDV > " + (await res));
    return res;
  }
