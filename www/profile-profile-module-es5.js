  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
    ...
    function srcAppPagesPatientProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(patienSrvc) {
        ...
        _createClass(ProfilePage, [{
                    ...
                    case 0:
                      if (this.patientRegisterForm.valid) {
                        Object.keys(this.patientRegisterForm.value).forEach(function (key) {
                          console.log("valid", _this.patientRegisterForm.value[key]);
                        });
                      } else {
                        console.log("NOT valid", this.patientRegisterForm);
                        Object.keys(this.patientRegisterForm.value).forEach(function (key) {
                          console.log("NOT valid", _this.patientRegisterForm.value[key]);
                        });
                      }
          ...
          value: function getProfile() {
            ...
            this.patienSrvc.getProfile().subscribe(function (data) {
              console.log(data);
              _this2.profile = data; // this.profile.date_on_born = new Date(data.date_on_born);

              _this2.buildForm(data);

              _this2.type_patient = data.type_patient == 1 ? "Enfant" : "Adult";
            });
          }
        }]);
