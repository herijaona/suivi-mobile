...
const routes = [
    ...
    {
        path: "patient",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-patient-patient-module */ "pages-patient-patient-module").then(__webpack_require__.bind(null, /*! ./pages/patient/patient.module */ "./src/app/pages/patient/patient.module.ts")).then((m) => m.PatientPageModule),
...
/* harmony import */ var src_constant__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/constant */ "./src/constant.ts");
...
/* harmony import */ var _services_interceptor_http_config_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/interceptor/http-config-interceptor */ "./src/app/services/interceptor/http-config-interceptor.ts");
...
const TOKEN_KEY = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].TOKEN_KEY;
let AuthService = class AuthService {
    constructor(http, helper, storage, alertCtrl, plt) {
        this.http = http;
        this.helper = helper;
...
let HttpConfigInterceptorService = class HttpConfigInterceptorService {
    ...
    intercept(request, next) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(promise).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["mergeMap"])((token) => {
...
CONSTANT = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({})
], CONSTANT);
...
module.exports = __webpack_require__(/*! D:\__Neitic\Full Time Work\Suivi-des-patients\Projet\suivi-via-mobile\src\main.ts */"./src/main.ts");
